...
export default class Drawer extends Component {
    ...
    initialize = (props) => {
        ...
        if (props.initializeOpen || props.open) { // open
            ...
            styles.main[this.props.side] = 0 // this._offsetClosed
    ...
    updatePosition = () => {
        ...
        switch (this.props.type) {
            case 'overlay':
                ...
                mainProps[this.props.side] = 0 // this._offsetClosed
                break
            case 'static':
    ...
    testPanResponderMask = (e, gestureState) => {
        ...
        if (!this._open && deltaClose + (this._offsetClosed * 2) > this.getClosedMask()) return false;
        return true
    };
    ...
    getMainHeight = (viewport = this.state.viewport) => {
        ...
        this.isTopOrBottomSide() ? viewport.height - this._offsetClosed : viewport.height
    };
    ...
    getClosedMask = () => {
        if (this.props.panOpenMask !== null && this.props.panOpenMask % 1 === 0) return this.props.panOpenMask
        if (this.props.panOpenMask !== null) return this.getDeviceLength() * this.props.panOpenMask;
